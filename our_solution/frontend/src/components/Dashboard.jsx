                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <div>
                                <div className="flex items-center gap-2 md:gap-3 flex-wrap">
                                    <h2 className="text-lg md:text-xl font-bold capitalize relative z-50" style={{ color: '#000' }}>
                                ...
                                <p className="text-xs md:text-sm font-bold hidden sm:block relative z-50" style={{ color: '#000' }}>
