...
Return ONLY valid JSON, no additional text."""
    ...
    def analyze_root_cause(self, alert: str, parsed: Dict, log_evidence: str,
                          case_context: str, kb_context: str) -> Dict:
...
Return ONLY valid JSON."""
    ...
    def get_resolution_steps(self, parsed: Dict, root_cause: Dict, kb_context: str,
                           case_solutions: str) -> Dict:
...
Return ONLY valid JSON."""
    ...
    def generate_report(self, alert: str, parsed: Dict, log_evidence: str,
                       similar_cases: str, root_cause: Dict, resolution: Dict) -> str:
